...
export default function NotFound() {
  ...
  return (
    <>
      <Head>
        <title>404 | Page Not Found | Scholarship Finder</title>
        <meta
          name="description"
          content="Sorry, the page you’re looking for doesn’t exist or has been moved. Return to the homepage to continue exploring scholarships and opportunities."
        />
